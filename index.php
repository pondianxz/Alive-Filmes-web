...
<head>
    ...
    <title>Início - Alive Filmes</title>
...
<body>
            ...
            <div class="navbar_parte_baixo" id="navbar_parte_baixo">
                <ul>
                    ...
                    <div class="div_navbar_parte_baixo_links_meio">
                        ...
                        <li>
                            <a href="#" class="navbar_texto_link">Contato</a>
                        </li>
                    </div>
    ...
    <section class="secao_1">
        <div class="container">
            <div class="textos_banner">
                <h1 class="slogan_banner">Cada frame é <span>inesquecível.</span></h1>
                <div class="div_paragrafo_banner">
                    <h2 class="paragrafo_banner">Venha ter a melhor experiência de cinema que você já viu.</h2>
                </div>
            </div>
        </div>
    </section>
    ...
    <section class="secao_2">
        <div class="secao_2_categorias">
            <a href="#">
                <div class="div_titulo_categoria_sessao">
                    <h2 class="titulo_categoria_sessao">Em Cartaz</h2>
                    <div class="linha_selecao_categoria_sessao"></div>
                </div>
            </a>
            <h2 class="titulo_categoria_sessao">|</h2>
            <a href="#">
                <div class="div_titulo_categoria_sessao">
                    <h2 class="titulo_categoria_sessao">Em Breve</h2>
                    <div class="linha_selecao_categoria_sessao"></div>
                </div>
            </a>
        </div>
        ...
        <div class="escolher_data_sessao">
            <div class="botoes_escolher_data">
                <button class="btn_escolher_data_sessao">Hoje</button>
                <button class="btn_escolher_data_sessao">Amanhã</button>
                <button class="btn_escolher_data_sessao">
                    <h2>QUINTA</h2>
                    <h2>11/09</h2>
                </button>
                <button class="btn_escolher_data_sessao">
                ...
                <button class="btn_seta_escolher_data">
                    <svg xmlns="http://www.w3.org/2000/svg" height="30px" viewBox="0 -960 960 960" width="30px" fill="#F3F3F3"><path d="M647-440H160v-80h487L423-744l57-56 320 320-320 320-57-56 224-224Z"/></svg>
                </button>
            </div>



            <button class="btn_escolher_data_especifica_sessao">
                <svg xmlns="http://www.w3.org/2000/svg" height="24px" viewBox="0 -960 960 960" width="24px" fill="#F3F3F3"><path d="M320-400q-17 0-28.5-11.5T280-440q0-17 11.5-28.5T320-480q17 0 28.5 11.5T360-440q0 17-11.5 28.5T320-400Zm160 0q-17 0-28.5-11.5T440-440q0-17 11.5-28.5T480-480q17 0 28.5 11.5T520-440q0 17-11.5 28.5T480-400Zm160 0q-17 0-28.5-11.5T600-440q0-17 11.5-28.5T640-480q17 0 28.5 11.5T680-440q0 17-11.5 28.5T640-400ZM200-80q-33 0-56.5-23.5T120-160v-560q0-33 23.5-56.5T200-800h40v-80h80v80h320v-80h80v80h40q33 0 56.5 23.5T840-720v560q0 33-23.5 56.5T760-80H200Zm0-80h560v-400H200v400Zm0-480h560v-80H200v80Zm0 0v-80 80Z"/></svg>
            </button>
        </div>


        <div class="filmes_em_alta">
            <svg xmlns="http://www.w3.org/2000/svg" height="48px" viewBox="0 -960 960 960" width="48px" fill="#F3F3F3"><path d="m136-240-56-56 296-298 160 160 208-206H640v-80h240v240h-80v-104L536-320 376-480 136-240Z"/></svg>
            <h2 class="titulo_popularidade_filme">EM ALTA</h2>
        </div>



        <div class="div_sessoes">
                ...
                <div class="div_conteudo_info_filme">
                    <div class="div_conteudo_parte1_info_filme">
                        <div class="div_link_filme_sessao">
                            <a href="#">
                                <h1 class="titulo_filme_info_filme">Invocação do Mal 4: O último ritual</h1>
                            </a>
                        </div>
                        <div class="descricao_filme">
                            ...
                            <div class="classificacao_indicativa_filme" id="classificacao_indicativa_16_anos_filme">
                                <h2>16 anos</h2>
                            </div>
                        ...
                        <div class="outras_infos_filme">
                            <p><span>Direção: </span>Michael Chaves</p>
                            <p><span>Elenco: </span>Vera Farmiga, Patrick Wilson, Mia Tomlinson</p>
                            <p><span>Distribuidora: </span>Warner Bosta</p>
                        </div>

                        <!-- Assistir trailer do filme (se tiver) -->
                        <div class="div_botao_trailer_filme">
                            <button class="btn_trailer_filme">
                ...
                <div class="div_conteudo_info_filme">
                    <div class="div_conteudo_parte1_info_filme">
                        <div class="div_link_filme_sessao">
                            <a href="#">
                                <!-- Título Filme -->
                                <h1 class="titulo_filme_info_filme">Filme 2</h1>
                            </a>
                        </div>
                        <div class="descricao_filme">
                            <!-- Título Filme-->
                            ...
                            <!-- Classificação indicativa filme -->
                            <div class="classificacao_indicativa_filme" id="classificacao_indicativa_18_anos_filme">
                                <h2>18 anos</h2>
                            </div>
                        ...
                        <!-- Outras informações do filme (direção, elenco e distribuidora) -->
                        <div class="outras_infos_filme">
                            <p><span>Direção: </span>Cellbit</p>
                            <p><span>Elenco: </span>Tom Holland, The Rock, Patrick do Bob Esponja</p>
                            <p><span>Distribuidora: </span>Sapato</p>
                        </div>
